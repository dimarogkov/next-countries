...
const CountryCard: React.FC<Props> = ({ country }) => {
    ...
    return (
        <Link
            href={name.common}
            className='w-full rounded-[8px] overflow-hidden border border-light dark:border-darkLight bg-white dark:bg-darkLight transition-opacity duration-300 hover:opacity-75'
        >
